...
echo "<td><input label='Endereço'name='AF_end'type='text'value='[blk_lista_saf01.AF_END]'size='50'> </td></tr>";
...
echo "<td><input label='Municipío'name='AF_minic'type='text'value='[blk_lista_saf01.AF_MUNICIPIO]'size='30'> </td></tr>";
