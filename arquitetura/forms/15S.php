...
echo '<td><input label="Codigo"name="id_p_saf01"type="text"value=""size="10"  onkeypress="mascara(this,soNumeros)"> </td></tr>';
echo '<tr><td width="110"><label for="nome_p_saf01">Nome </label></td>';
echo '<td><input label="Nome"name="nome_p_saf01"type="text"value=""size="50"  > </td></tr>';
echo '</table>';
echo '<input name="idsecao"type="hidden"value="15S"size="2">';
echo '<input name="form"type="hidden"value="vpsaf01"size="6" >';
echo '</table>';
