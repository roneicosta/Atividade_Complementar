...
echo "<tr><td><input name='CD_ID'type='hidden'value='[blk_bas_alt.C1_ID]'size='10'></td></tr>";
...
echo "<td><input name='CD_mosid'type='text'value='[blk_bas_alt.C1_ID]'size='5' disabled></td>";
echo "<tr><td width='110'><label for='CD_nome'>Nome</label></td>";
echo "<td><input label='Nome'name='CD_nome'type='text'value='[blk_bas_alt.C1_DESCR]'size='70'Req='true' Camp='Nome'> </td></tr>";
echo "<tr><td width='110'><label for='CD_ch'>Limite C. Horária</label></td>";
echo "<td><input label='CD_ch'name='CD_ch'type='text'value='[blk_bas_alt.C1_LIMITECH]'size='13' maxlength='13' onkeypress='mascara(this,soNumeros)'> </td></tr>";
