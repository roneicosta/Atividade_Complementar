...
echo "<div id='titcad'>Cadastro Período</div>";
...
echo "<tr><td><input name='AL_ID'type='hidden'value='[blk_bas_alt.AL_ID]'size='10'></td></tr>";
echo "<tr><td><input name='AL_filial'type='hidden'value='00'size='10'></td></tr>";
echo "<tr><td width='110'><label for='AL_mosid'>Código/ID</label></td>";
echo "<td><input name='AL_mosid'type='text'value='[blk_bas_alt.AL_ID]'size='5' disabled></td>";
echo "<tr><td width='110'><label for='AL_nome'>Nome</label></td>";
echo "<td><input label='Nome'name='AL_nome'type='text'value='[blk_bas_alt.AL_DESCR]'size='50'Req='true' Camp='Nome'> </td></tr>";
