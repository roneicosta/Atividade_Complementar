...
echo "<form name='SA301' action='index.php' method='post'  onSubmit='return checkEditvFields(this)'>";
echo '<div class="simpleTabs">';
echo "<table border=0 bgcolor='#E6E6E6' width='100%'>";
echo "<tr><td><input name='A3_ID'type='hidden'value='0'size='10'></td></tr>";
echo "<tr><td><input name='A3_filial'type='hidden'value='00'size='10'></td></tr>";
echo "<tr><td width='110'><label for='A3_mosid'>Código/ID</label></td>";
echo "<td><input name='A3_mosid'type='text'value='0'size='5' disabled></td>";
echo "<tr><td width='110'><label for='A3_nome'>Nome</label></td>";
echo "<td><input label='Nome'name='A3_nome'type='text'value=''size='80'Req='true' Camp='Nome'> </td></tr>";
