...
echo "&nbsp;<input  type='text' label='C5_idativ' id='C5_mosativ' name='C5_mosativ' Req='true' Camp='Atividade' size='70' disabled></td></tr>";
...
echo "&nbsp;<input  type='text' label='C5_moseve' id='C5_moseve' name='C5_moseve' Req='true' Camp='Evento' size='70' disabled></td></tr>";
...
echo "&nbsp;<input  type='text' label='C5_mosinst' id='C5_mosinst' name='C5_mosinst' Req='true' Camp='Evento' size='70' disabled></td></tr>";
...
echo "<tr><td><input id='C5_idativ' name='C5_idativ'type='hidden'value=''size='7'></td>
          <td><input id='C5_ideve' name='C5_ideve' type='hidden'value=''size='7'></td>
		  <td><input id='C5_idinst' name='C5_idinst' type='hidden'value=''size='7'></td></tr>";
