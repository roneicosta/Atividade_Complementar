...
echo "<tr><td width='110'><label for='M0_ID'>Código</label></td>";
echo "<td><input label='M0_ID'name='M0_ID'type='text'value=''size='5' required=true field='Codigo' maxlength='2' onkeypress='mascara(this,soNumeros)'> </td></tr>";
echo "<tr><td width='110'><label for='M0_nome'>Nome Empresa</label></td>";
echo "<td><input label='Nome'name='M0_nome'type='text'value=''size='50'Req='true' Camp='Nome Empresa'> </td></tr>";
echo "<tr><td width='110'><label for='M0_end'>Endereço </label></td>";
echo "<td><input label='Endereço'name='M0_end'type='text'value=''size='50'> </td></tr>";
...
echo "<td><input label='Municipío'name='M0_minic'type='text'value=''size='30'> </td></tr>";
echo "<tr><td width='110'><label for='M0_est'>UF </label></td>";
echo "<td><select  label='UF' name='M0_est' >" . lista_nest()."</select></td></tr>";
echo "<tr><td width='110'><label for='M0_cep'>Cep </label></td>";
echo "<td><input label='Cep'name='M0_cep'type='text'value=''size='10'onkeypress='mascara(this,cep)' maxlength='9'> </td></tr>";
echo "<tr><td width='110'><label for='M0_fone'>Fone </label></td>";
echo "<td><input label='Fone'name='M0_fone'type='text'value=''size='14' onkeypress='mascara(this,telefone)' maxlength='14'> </td></tr>";
echo "<tr><td width='110'><label for='M0_cnpj'>CNPJ</label></td>";
echo "<td><input label='M0_CNPJ'name='M0_CNPJ'type='text'value=''size='16' onkeydown='mascara(this,cnpj)' maxlength='18'> </td></tr>";
