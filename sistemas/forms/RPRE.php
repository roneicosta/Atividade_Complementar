...
echo "<div id='titrel' align='center'>Programação Estágio</div>";
echo "<div id='titcad2'><label id='nome'></label></div>";
echo "<form name='RPRE' action='index.php' method='get'  onSubmit='return checkEditvFields(this)'>";
echo '<div class="simpleTabs">';
echo "<table border='0' bgcolor='#E6E6E6' width='50%' align='center'>";
echo "<tr><td><input name='form'type='hidden'value='RPRE'size='2'></td>
...
echo "<tr><td align='center'><input type='radio' name='tp' value='pdf' checked onClick='pegaradio(document.RPRE, document.RPRE.formato.name)' TITLE='Visualizar em PDF'/></td>
          <td align='center'><input type='radio' name='tp' value='docx' onClick='pegaradio(document.RPRE, document.RPRE.formato.name)' TITLE='Visualizar em Word DOCX'/></td>
          <td align='center'><input type='radio' name='tp' value='xls' onClick='pegaradio(document.RPRE, document.RPRE.formato.name)' TITLE='Visualizar em Excel XLS'/></td>
          <td align='center'><input type='radio' name='tp' value='rtf' onClick='pegaradio(document.RPRE, document.RPRE.formato.name)' TITLE='Visualizar em RTF'/></td>
          <td align='center'><input type='radio' name='tp' value='br' onClick='pegaradio(document.RPRE, document.RPRE.formato.name)' TITLE='Visualizar em BrOffice'/></td></tr>";		            
echo '<tr><td colspan="6" align="center">
<input name="enviar" type="submit" value="Imprimir/Visualizar"
onClick=\'if(document.RPRE.idt_p.value != "") {javascript:void(centerpopup("Report/Reports.php?mod=RPRE&ano_p=[var._SESSION.anopric]&sem_p=[var._SESSION.sempric]&idc_p=[var._SESSION.cursopric]&idt_p="+document.RPRE.idt_p.value+"&tp="+document.RPRE.formato.value,"POPUP",500,1600))}\'></td></tr>';
echo "</table>";
