...
echo "<form name='CEPA' action='index.php' method='post'  onSubmit='return checkEditvFields(this)'>";
...
echo "<td><select style='width:90%;' label='EP_idest' name='EP_idest' Req='true' Camp='Estágio'><option value=''></option><option value='[blk_select_se301.E3_ID;block=option]'>[blk_select_se301.E3_ID] | [blk_select_se301.E3_IDDISC]-[blk_select_se301.A3_DESCR;ope=max:30] | [blk_select_se301.E1_FANTASIA;ope=max:30] | [blk_select_se301.E2_DESCRICAO;ope=max:30]</option></select><script>document.CEPA.EP_idest.value = '[blk_lista_se401.E4_IDESTAGIO]';</script></td></tr>";
echo "<tr><td width='110'><label for='EP_dia'>Dia Semana</label></td>";
echo "<td><select  label='A8_dia' name='EP_dia' Req='true' Camp='Dia Semana'><option value=''></option>".lista_diasemana()."</select><script>document.CEPA.EP_dia.value = '[blk_lista_se401.E4_DIASEMANA]';</script></td></tr>";
echo "<tr><td width='110'><label for='EP_idprof'>Professor</label></td>";
echo "<td><select style='width:90%;' label='EP_idprof' name='EP_idprof' Req='true' Camp='Professor'><option value=''></option><option value='[blk_select_saf01.AF_ID;block=option]'>[blk_select_saf01.AF_DESCR;ope=max:40] - [blk_select_saf01.AF_ID]</option></select><script>document.CEPA.EP_idprof.value = '[blk_lista_se401.E4_IDPROF]';</script></td></tr>";
echo "<tr><td width='110'><label for='EP_dia'>Turno</label></td>";
echo "<td><select  label='A8_turno' name='EP_turno' Req='true' Camp='Turno'><option value=''></option>".lista_turno()."</select><script>document.CEPA.EP_turno.value = '[blk_lista_se401.E4_TURNO]';</script></td></tr>";
