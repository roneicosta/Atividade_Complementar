...
echo "<tr><td><input name='C2_ID'type='hidden'value='[blk_bas_alt.C2_ID]'size='10'></td></tr>";
...
echo "<td><input name='C2_mosid'type='text'value='[blk_bas_alt.C2_ID]'size='5' disabled></td>";
echo "<tr><td width='110'><label for='C2_nome'>Nome</label></td>";
echo "<td><input label='Nome'name='C2_nome'type='text'value='[blk_bas_alt.C2_DESCR]'size='70'Req='true' Camp='Nome'> </td></tr>";
echo "<tr><td width='110'><label for='C2_ch'>Carga Horária</label></td>";
echo "<td><input label='C2_ch'name='C2_ch'type='text'value='[blk_bas_alt.C2_CHORARIA]'size='13' maxlength='13' onkeypress='mascara(this,soNumeros)'> </td></tr>";
