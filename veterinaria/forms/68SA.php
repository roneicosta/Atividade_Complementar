...
echo "<td><select  style='width:70%;' label='C5_idativ' name='C5_idativ' Req='true' Camp='Atividade'><option value=''></option><option value='[blk_select_sc101.C1_ID;block=option]'>[blk_select_sc101.C1_DESCR;ope=max:60]-[blk_select_sc101.C1_ID]</option></select><script>document.CADATI.C5_idativ.value = '[blk_lista_sc501.C5_IDATIVIDADE]';</script></td>";
echo "<tr><td width='110'><label for='C5_idativ'>Evento</label></td>";
echo "<td><select style='width:70%;' label='C5_ideve' name='C5_ideve' Req='true' Camp='Evento' ><option value=''></option><option value='[blk_select_sc201.C2_ID;block=option]'>[blk_select_sc201.C2_DESCR;ope=max:60]-[blk_select_sc201.C2_ID]</option></select><script>document.CADATI.C5_ideve.value = '[blk_lista_sc501.C5_IDEVENTO]';</script></td></tr>";
echo "<tr><td width='110'><label for='C5_idinst'>Instituição</label></td>";
echo "<td><select style='width:70%;' label='C5_idinst' name='C5_idinst' Req='true' Camp='Instituição'><option value=''></option><option value='[blk_lista_sc401.C4_ID;block=option]'>[blk_lista_sc401.C4_DESCR;ope=max:60]-[blk_lista_sc401.C4_ID]</option></select><script>document.CADATI.C5_idinst.value = '[blk_lista_sc501.C5_IDINSTITUICAO]';</script></td></tr>";
